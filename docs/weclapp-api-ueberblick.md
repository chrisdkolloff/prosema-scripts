...
**Ausnahme:** Neue Haupt- und Untergruppen, die auf [tools.prosema.ch](https://tools.prosema.ch/gruppen) angelegt, umbenannt, gelöscht oder wiederhergestellt werden, schreibt die Tools-Website auch in weclapp als Artikelkategorien. Details und Grenzen stehen in [gruppen-verwaltung.md](gruppen-verwaltung.md).
